...
class SymbolTable:
    ...
    def get_next_available_address(self) -> int:
        """Returns the next available RAM address for variable allocation.

        Returns:
            int: the next available RAM address.
        """
        return self._next_available_address

    def increment_next_available_address(self) -> None:
        """Increments the next available RAM address for variable allocation by 1.
        """
